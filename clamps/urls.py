...
urlpatterns = [
    ...
    path('management/users/batch_add/', views.batch_add_users, name='batch_add_users'),
    path('management/users/batch_add_template/', views.batch_add_template, name='batch_add_template'),
